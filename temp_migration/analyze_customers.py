...
# Read customers data
df = pd.read_excel('transactions/Customers.xlsx', sheet_name='Customer Contact List', skiprows=3)

# Clean up column names
df.columns = ['empty', 'customer_name', 'phone', 'email', 'full_name', 'billing_address', 'shipping_address']
