...
# Read vendors data
df = pd.read_excel('transactions/Vendors.xlsx', sheet_name='Vendor Contact List', skiprows=3)

# Clean up column names
df.columns = ['empty', 'vendor_name', 'phone', 'email', 'full_name', 'address', 'account_number']
...
contractors_suppliers = [
    ...
    'Heatcore Inc', 'Upstream Data', 'Vibe Energy Systems'
]
