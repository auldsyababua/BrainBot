...
from flrts.core.auth import is_user_authorized
...
from flrts.core.version import LATEST_CHANGES, VERSION
...
async def reset_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from flrts.core.llm import reset_conversation
...
async def continue_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from flrts.core.llm import restore_conversation
